...
def agrupar_por_escuela(df_FluidezLectora_1):
    df_Desempeño_por_Escuela = Módulos.DataETC.desempeño.calcular_desempeño(
        ['Escuela_ID'],
    ...
    df_Desempeño_por_Escuela[
        'Total_Alumnos_por_Tipo_de_Desempeño'] = df_Desempeño_por_Escuela[
            'Total_Alumnos_por_Tipo_de_Desempeño'].astype(int).round(0)
    # reducir la cantidad de decimales
    df_Desempeño_por_Escuela[
        'Desempeño_por_Escuela'] = df_Desempeño_por_Escuela[
    ...
    df_Desempeño_por_Escuela[
        'Total_Alumnos_por_Escuela_ID'] = df_Desempeño_por_Escuela[
            'Total_Alumnos_por_Escuela_ID'].astype(int).round(0)
    df_Desempeño_por_Escuela[
        'Total_Alumnos_por_Escuela_ID'] = df_Desempeño_por_Escuela[
            'Total_Alumnos_por_Escuela_ID'].fillna(0)    

    return df_Desempeño_por_Escuela
